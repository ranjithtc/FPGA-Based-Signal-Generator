...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../gpio.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../gpio.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../gpio.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../gpio.gen/sources_1/bd/system/ipshared/ee60/hdl" \
