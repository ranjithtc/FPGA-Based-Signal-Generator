...
#
# Generated by Vivado on Sun Nov 19 14:31:44 CST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../gpio.gen/sources_1/ip/DAC_vio_0/hdl/verilog" +incdir+"$ref_dir/../../../../gpio.gen/sources_1/ip/DAC_vio_0/hdl" +incdir+"$ref_dir/../../../../gpio.gen/sources_1/ip/vio_0_4/hdl/verilog" +incdir+"$ref_dir/../../../../gpio.gen/sources_1/ip/vio_0_4/hdl" +incdir+"/home/ranjithgowda/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../gpio.gen/sources_1/ip/vio_0_4/sim/vio_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ranjithgowda/Documents/FPGA/Projects/Project_2_1/Project_2/gpio/gpio.cache/compile_simlib/vcs"
  fi
