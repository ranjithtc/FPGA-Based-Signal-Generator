proc create_ipi_design { offsetfile design_name } {
	...
	set wavegen_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:wavegen:1.0 wavegen_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:wavegen:1.0]]]]
